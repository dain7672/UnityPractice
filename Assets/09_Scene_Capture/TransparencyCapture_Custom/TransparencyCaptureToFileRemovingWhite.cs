...
public class TransparencyCaptureToFileRemovingWhite:MonoBehaviour
{
    ...
    public IEnumerator capture(int currentFrame)
    {
        ...
        zzTransparencyCaptureRemovingWhite.captureScreenshot("capture/capture" + currentFrame + ".png");
